  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 24.h),
        _buildTextFieldLabel("CATEGORIES (Select at least one) *"),
        Obx(() => Wrap(
              spacing: 8.w,
              runSpacing: 8.h,
              children: controller.availableCategories.map((cat) {
                bool isSelected = controller.selectedCategories.contains(cat);
                return GestureDetector(
                  onTap: () => controller.toggleCategory(cat),
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 8.h),
                    decoration: BoxDecoration(
                      color: isSelected ? const Color(0xFF3B82F6).withOpacity(0.2) : const Color(0xFF1C2237),
                      border: Border.all(
  ...
  Widget _buildStep2() {
    return Column(
      ...
      children: [
        ...
        _buildFileSelector("Upload Video (MP4) *", Icons.videocam,
            controller.selectedVideo.value, controller.pickVideo),
        SizedBox(height: 16.h),
        _buildFileSelector(
        ...
        SizedBox(height: 16.h),
        _buildFileSelector("Upload Project PPT (PDF) *", Icons.slideshow,
            controller.selectedPpt.value, controller.pickPpt),
      ],
    );
  }

  Widget _buildFileSelector(
      String title, IconData icon, String selectedValue, VoidCallback onTap) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon,
                color: hasFile ? const Color(0xFF3B82F6) : textGrey,
                size: 24.sp),
            SizedBox(width: 16.w),
            Expanded(
              child: Column(
                  ...
                  if (hasFile)
                    Padding(
                      ...
                      child: Text("Tap to change",
                          style: TextStyle(color: textGrey, fontSize: 10.sp)),
                    )
                ],
              ),
            ),
    ...
    return Column(
      ...
      children: [
                ...
                child: Stack(
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.vertical(top: Radius.circular(16.r), bottom: Radius.circular(16.r)),
                        ...
                        children: [
                          ...
                          Text(
                            controller.taglineController.text.isNotEmpty
                                ...
                                : "A platform to build scalable AI models",
                            style: TextStyle(
        ...
        Wrap(
          spacing: 8.w,
          runSpacing: 8.h,
          children: controller.selectedTechs
              .map((tech) => _buildTechChip(tech, Colors.cyan))
              .toList(),
        ),
        SizedBox(height: 24.h),
        Row(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixText: " Members",
                        suffixStyle: TextStyle(color: textGrey, fontSize: 14.sp),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    Text("REPOSITORY",
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                    SizedBox(height: 4.h),
                    Text(controller.repoUrlController.text,
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 12.sp,
                            fontWeight: FontWeight.bold),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    Text(
                        controller.demoLinkController.text.isNotEmpty
                            ? controller.demoLinkController.text
                            : "N/A",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 12.sp,
        ...
        Row(
          children: controller.selectedImages
              .take(3)
              .map((path) => _buildMediaThumb(path))
              .toList(),
        ),
        SizedBox(height: 16.h),
        Container(
          ...
          child: Column(
            children: [
              if (controller.selectedVideo.value.isNotEmpty)
                _buildFinalFileRow(
                    Icons.videocam, controller.selectedVideo.value),
              if (controller.selectedReport.value.isNotEmpty)
                _buildFinalFileRow(
                    Icons.picture_as_pdf, controller.selectedReport.value),
              if (controller.selectedPpt.value.isNotEmpty)
                _buildFinalFileRow(
                    Icons.slideshow, controller.selectedPpt.value),
            ],
          ),
        ),
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Padding(
            padding: EdgeInsets.only(
                bottom: maxLines > 1 ? (16.h * maxLines) / 2 : 0),
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: (controller.isUploading ||
                        ...
                        : () {
                            if (controller.currentStep.value < 3) {
                              ...
                              if (controller.teamSizeController.text.trim().isEmpty ||
                                  controller.durationController.text.trim().isEmpty ||
                                  controller.memberNameController.text.trim().isEmpty) {
                                Get.snackbar(
                                  "Required Fields",
                                  "Team size, duration, and member names are required.",
                              ...
                              controller
                                  ...
                                  .then((success) {
                                if (success) {
                                  // Step 2: Build ProjectModel with Cloudinary URLs
                                  int memberSize = int.tryParse(
                                        controller.teamSizeController.text
                                  ...
                                  ProjectModel model = ProjectModel(
                                    ...
                                    description:
                                        controller.descriptionController.text,
                                    images:
                                        controller.uploadedImageUrls.toList(),
                                    video: controller.uploadedVideoUrl.value,
                                    projectReportPdf:
                                        controller.uploadedReportUrl.value,
                                    projectPptPdf:
                                        controller.uploadedPptUrl.value,
                                    technologies:
                                        controller.selectedTechs.toList(),
                                    repoLink: controller.repoUrlController.text,
                                    demoLink:
                                        controller.demoLinkController.text,
                                    memberSize: memberSize,
                                    duration:
                                        controller.durationController.text,
                                    memberNames: controller.memberNameController
                                            .text.isNotEmpty
                                    ...
                                    memberIds: controller.memberIdController
                                        .text.isNotEmpty
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      shadowColor: controller.currentStep.value == 3
                    ...
                    child: (controller.isUploading ||
                        ...
                        : Row(
                            ...
                            children: [
                              if (controller.currentStep.value == 3)
                                Icon(MaterialCommunityIcons.rocket_launch,
                      ...
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            Icon(MaterialCommunityIcons.check_decagram,
                                color: const Color(0xFF2563EB), size: 100.sp),
                          ],
                        ),
                        SizedBox(height: 40.h),
                        Text(
                        ...
                        SizedBox(height: 16.h),
                        Text(
                          "Your innovative project is sent to \nadmin for approval.",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: textGrey, fontSize: 16.sp, height: 1.5),
                        ),
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (controller.selectedVideo.value.isNotEmpty ||
                            ...
                            controller.selectedPpt.value.isNotEmpty) ...[
                          Text("Files",
                              style: TextStyle(
                                  color: textGrey,
                                  fontSize: 14.sp,
                          ...
                          if (controller.selectedVideo.value.isNotEmpty)
                            _buildFinalFileRow(
                                Icons.videocam, controller.selectedVideo.value),
                          if (controller.selectedReport.value.isNotEmpty)
                            _buildFinalFileRow(Icons.picture_as_pdf,
                                controller.selectedReport.value),
                          if (controller.selectedPpt.value.isNotEmpty)
                            _buildFinalFileRow(
                                Icons.slideshow, controller.selectedPpt.value),
